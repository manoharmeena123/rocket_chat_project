        ...
        <div className="col-12">
          <div className="form-group">
            ...
            <textarea
              ...
              cols="20"
              rows="5"
              placeholder="I'm the Front-End Developer for #Nators IT in Bangladesh, OR. I have serious passion for UI effects, animations and creating intuitive, dynamic user experiences."
            ></textarea>
          </div>
        </div>
