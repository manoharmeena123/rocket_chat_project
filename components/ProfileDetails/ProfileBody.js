...
const ProfileBody = () => {
  const [text, setText] = useState(
    "My name is Fazlay Elahi Rafi and I'm a Front-End Developer of #Nators IT in Bangladesh, OR. I have serious passion for UI effects, animations and creating intuitive, dynamic user experiences."
  );
